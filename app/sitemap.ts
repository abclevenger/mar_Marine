...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/guides/hurricane-storm-boat-protection`, changeFrequency: "monthly", priority: 0.6, lastModified: LAST_MODIFIED },
    { url: `${BASE_URL}/guides/choosing-a-marina-tarpon-springs`, changeFrequency: "monthly", priority: 0.6, lastModified: LAST_MODIFIED },
